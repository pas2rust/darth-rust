...
pub fn generate_printers(input: &DeriveInput) -> proc_macro2::TokenStream {
    ...
    quote! {
        ...
        pub fn print(&self, custom: &str) {
            let message = format!("{} @PRINT ➝ {:#?} ➝ ({})", chrono::Utc::now(), &self, custom);
            println!("{}", message);
        }
        ...
        pub fn print_rust(&self, custom: &str) {
            ...
            let message = format!("{} @RUST ➝ {:#?} ➝ ({})", chrono::Utc::now(), &self, custom);
        ...
        pub fn print_info(&self, custom: &str) {
            use colorful::{Color, Colorful};
            let message = format!("{} @INFO ➝ {:#?} ➝ ({})", chrono::Utc::now(), &self, custom);
        ...
        pub fn print_success(&self, custom: &str) {
            use colorful::{Color, Colorful};
            let message = format!("{} @SUCCESS ➝ {:#?} ➝ ({})", chrono::Utc::now(), &self, custom);
        ...
        pub fn print_warning(&self, custom: &str){
            use colorful::{Color, Colorful};
            let message = format!("{} @WARNING ➝ {:#?} ➝ ({})", chrono::Utc::now(), &self, custom);
        ...
        pub fn print_err(&self, custom: &str){
            use colorful::{Color, Colorful};
            let message = format!("{} @ERR ➝ {:#?} ➝ ({})", chrono::Utc::now(), &self, custom);
